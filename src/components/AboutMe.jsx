...
export const AboutMe = () => {
  ...
  viewport={{ amount: 0.7 }}
  className="about-me text-white text-sm leading-6 mt-3 text-justify"
>
  <p className="mb-2">
    Hi, I&apos;m <strong>Vritika</strong> — a frontend developer with a creative eye for design and a background in AI and Data Science. I love crafting clean, responsive, and engaging web interfaces.
  </p>
  <ul className="space-y-1 ml-1">
  <li>🎓 Pursuing B.Tech in Artificial Intelligence and Data Science</li>
  <li>⚛️ Experienced in React, Next.js, and Tailwind CSS</li>
  <li>🎨 Passionate about UI/UX design — from wireframes to live frontend</li>
  <li>🚀 Built MVPs for hackathons and startup ideas, including a hyperlocal marketplace</li>
  <li>📱 Focused on performance, accessibility, and scalable component structure</li>
  <li>🌐 Exploring full-stack development using MongoDB and API integrations</li>
</ul>
</motion.div>
          ...
          <div className="h-screen flex max-md:flex-col md:items-center gap-5">
            <div className="flex flex-col md:w-1/2 h-3/4">
              <div className="flex flex-col justify-center p-5 max-md:items-center">
                ...
                >
                   I craft responsive, user-friendly websites using modern technologies — blending clean, scalable code with thoughtful, creative design. With a strong focus on React, Next.js, and UI/UX, I bring ideas to life through performance-driven, accessible digital experiences.
